  ...
  #Plot random values and highlight selected values 
    output$distPlot1 <- renderPlot({
       Sim  %>% 
        ...
        geom_label(aes(x = d1(), y = Cr1(t1(), h1(), d1(), g1()), label = paste("t = ", round(t1(),2), "H = ", round(h1(),2), "D = ", round(d1(),2), "G = ", round(g1(),2))),
    ...
    output$distPlot2 <- renderPlot({
      Sim  %>% 
        ...
        geom_label(aes(x = d2(), y = Cr2(t2(), h2(), d2(), g2()), label = paste("t = ", round(t2(),2), "H = ", round(h2(),2), "D = ", round(d2(),2), "G = ", round(g2(),2))),
                   hjust = 0, vjust = -1, fill = "orange", colour = "darkblue", alpha= 0.5)
